...
var createProps = function createProps(vnode, _ref3) {
  ...
  _defineProperty({
    className: [attrs.subClassName || classes.component, attrs.fromMultipleClassName, attrs.fullScreen ? classes.fullScreen : null, attrs.modal ? classes.modal : null, attrs.backdrop ? classes.showBackdrop : null,
