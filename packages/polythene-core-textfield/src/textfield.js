    ...
    h("div",
      ...
      [
        ...
        h(inputType, Object.assign(
          ...
          autofocus !== undefined ? { [k.autofocus]: autofocus } : null,
          maxlength !== undefined ? { [k.maxlength]: maxlength } : null,
          minlength !== undefined ? { [k.minlength]: minlength } : null,
          readonly !== undefined  ? { [k.readonly]: true }       : null,
          rows !== undefined      ? { rows }                     : null,
          tabindex !== undefined  ? { [k.tabindex]: tabindex }   : null,
          {...rest}
        ))
      ]
    ),
